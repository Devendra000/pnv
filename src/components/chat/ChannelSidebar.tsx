...
export function ChannelSidebar({ session }: ChannelSidebarProps) {
  ...
  return (
    <aside className="w-64 bg-card border-r border-border flex flex-col h-full select-none shrink-0">
      ...
      <div className="p-4 border-b border-border/80 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-sm font-bold text-foreground leading-tight">PNV Workspace</div>
      ...
      <div className="flex-1 overflow-y-auto px-3 py-4 space-y-6">
        ...
        <div>
          <div className="flex items-center justify-between px-2 mb-2 text-muted-foreground">
            ...
            <button
              ...
              className="p-1 rounded-md hover:text-foreground hover:bg-muted transition-all"
            ...
            {publicChannels.map((c) => {
              ...
              return (
                ...
                >
                  ...
                  {c.unreadCount > 0 && (
                    <span className="px-1.5 py-0.2 min-w-4 h-4 rounded-full text-[10px] font-bold bg-primary text-white flex items-center justify-center shrink-0">
        ...
        {userGroupChannels.length > 0 && (
          <div>
            <div className="flex items-center justify-between px-2 mb-2 text-muted-foreground">
              <span className="text-[11px] font-bold uppercase tracking-wider flex items-center gap-1.5 text-primary">
          ...
          <div className="space-y-0.5">
            {otherUsers.length === 0 ? (
              <div className="px-2.5 py-2 text-[11px] text-muted-foreground italic">
                {session?.user?.role === "ADMIN" ? (
                  <span>No other members yet. <Link href="/admin/users" className="text-primary underline">Add users</Link></span>
                ) : (
        ...
        {session?.user?.role === "ADMIN" && (
          <div>
            <div className="px-2 mb-2 text-muted-foreground text-[11px] font-bold uppercase tracking-wider flex items-center gap-1.5">
